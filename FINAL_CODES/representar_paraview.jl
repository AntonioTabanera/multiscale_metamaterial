...
function plot_paraview_estructura_metamaterial(coords,conectividad,desplazamientos,giros,fuerzas,momentos)
    ...
    fichero_plot=open(raw"C:\__UNIVERSIDAD__\AEROESPACIAL\4º GIA\TFG\representaciones_paraview\metamaterial.vtu","w") #crear el archivo
...
function plot_paraview_solido_tetraedros(coords, conectividad, u, f)
    ...
    fichero_plot=open(raw"C:\__UNIVERSIDAD__\AEROESPACIAL\4º GIA\TFG\representaciones_paraview\solido_tetraedros\solido_tetraedros.vtu","w") #crear el archivo
    write(fichero_plot, """<?xml version="1.0"?> \n""")
...
function plot_paraview_solido_hexaedros(coords, conectividad, u, f)
    ...
    fichero_plot=open(raw"C:\__UNIVERSIDAD__\AEROESPACIAL\4º GIA\TFG\representaciones_paraview\solido_hexaedros\solido_hexaedros.vtu","w") #crear el archivo
    write(fichero_plot, """<?xml version="1.0"?> \n""")
