...
gradiente=false#true#       #Para aplicar o no el método del gradiente para redcir errores al hacer el acoplamiento multiescala

iter_desplaz=10;        #Numero de iteraciones en desplazamiento hasta alcanzar el valor del desplazamiento final
iter_max=2;             #Numero de iteraciones para converger en cada desplazamiento
...
iter_max_gradiente=2        #Numero de iteraciones maximas para cada vez que se intenta corregir con el metodo de gradiente
...
# desplazamiento 1
punto_desplazamiento=[X "all" "all"]#
valor_desplazamiento=[ 0  0 10e-3 ]
